...
export default function Home() {
  const stats: StatsDataType[] = [
    { name: "developer experience", value: "10+", unit: "years" },
    {
      name: "decrease in production breaking incidents",
      value: "90",
      unit: "%",
    },
    { name: "production uptime", value: "99", unit: "%", delta: 19 },
    { name: "CI/CD pipelines implemented", value: "16" },
  ]
  ...
  return (
    <>
      <main>
        {/* <Image
          src={hero}
          alt="A gradient background of gray and orange"
          className="absolute top-0 left-0 -z-10 w-dvw h-96"
          fill
        ></Image> */}
        <div className="flex flex-col justify-between text-center gap-6 mb-12 lg:flex-row lg:text-left">
          <div className="lg:max-w-[60%]">
            <h1 className="text-gray-300 lg:text-8xl">Hi, I&apos;m Bob</h1>
            <h1 className="text-gray-300">VanLonkhuyzen</h1>
            <br />
            <div className="flex flex-wrap flex-col md:flex-row whitespace-nowrap gap-3 py-4">
              <h2 className="text-gray-300 mb-6 lg:mb-2">Web Developer,</h2>
              <h2 className="text-gray-300 mb-6 lg:mb-2">
                Application Developer,
              </h2>
              <h2 className="text-gray-300 mb-6 lg:mb-2">DevOps Engineer</h2>
            </div>
            <div className="flex flex-wrap justify-center gap-5 lg:justify-start py-4">
        ...
        <div className="grid gap-8">
          {/* Stats block */}
          <Stats
            className="bg-gray-600 dark:bg-gray-800 shadow-2xl font-semibold"
            heading="Experience that delivers results"
            stats={stats}
          />
          {/* Clients grid block */}
          <div className="text-center font-semibold px-4 py-24 rounded-lg">
            <h2>Some of the clients I have worked with</h2>
          ...
          <section className="bg-white py-24 sm:py-32 dark:bg-gray-900">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                <div className="relative flex flex-col pb-10 sm:pb-16 lg:pr-8 lg:pb-0 xl:pr-20">
                  <svg
                    fill="none"
                    viewBox="0 0 162 128"
                    aria-hidden="true"
                    className="absolute top-0 left-0 h-32 stroke-white/20"
                  >
                    <path
                  ...
                  <figure className="mt-10 flex flex-auto flex-col justify-between">
                    <blockquote className="text-lg/8 text-gray-900 dark:text-gray-100">
                      <p>
                        Bob has done well demonstrating the values of
                        innovation. He has made strides to implement new
                        features into our environment such as unit/automated
                        testing, and he has been an active and highly valued
                        participant in technical discussions.”
                      </p>
                    </blockquote>
                    <figcaption className="mt-10 flex items-center gap-x-6">
                      ...
                      <div className="text-base">
                        ...
                        <div className="mt-1 text-gray-500 dark:text-gray-400">
                          Supervisor, IT Software Engineering
                        </div>
                      </div>
                    </figcaption>
                  </figure>
                </div>
                <div className="relative flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-8 xl:pl-20 dark:border-white/10">
                  <svg
                    fill="none"
                    viewBox="0 0 162 128"
                    aria-hidden="true"
                    className="absolute sm:top-16 lg:top-0 lg:left-8 xl:left-20 h-32 stroke-white/20"
                  >
                    <path
                      d="M65.5697 118.507L65.8918 118.89C68.9503 116.314 71.367 113.253 73.1386 109.71C74.9162 106.155 75.8027 102.28 75.8027 98.0919C75.8027 94.237 75.16 90.6155 73.8708 87.2314C72.5851 83.8565 70.8137 80.9533 68.553 78.5292C66.4529 76.1079 63.9476 74.2482 61.0407 72.9536C58.2795 71.4949 55.276 70.767 52.0386 70.767C48.9935 70.767 46.4686 71.1668 44.4872 71.9924L44.4799 71.9955L44.4726 71.9988C42.7101 72.7999 41.1035 73.6831 39.6544 74.6492C38.2407 75.5916 36.8279 76.455 35.4159 77.2394L35.4047 77.2457L35.3938 77.2525C34.2318 77.9787 32.6713 78.3634 30.6736 78.3634C29.0405 78.3634 27.5131 77.2868 26.1274 74.8257C24.7483 72.2185 24.0519 69.2166 24.0519 65.8071C24.0519 60.0311 25.3782 54.4081 28.0373 48.9335C30.703 43.4454 34.3114 38.345 38.8667 33.6325C43.5812 28.761 49.0045 24.5159 55.1389 20.8979C60.1667 18.0071 65.4966 15.6179 71.1291 13.7305C73.8626 12.8145 75.8027 10.2968 75.8027 7.38572C75.8027 3.6497 72.6341 0.62247 68.8814 1.1527C61.1635 2.2432 53.7398 4.41426 46.6119 7.66522C37.5369 11.6459 29.5729 17.0612 22.7236 23.9105C16.0322 30.6019 10.618 38.4859 6.47981 47.558L6.47976 47.558L6.47682 47.5647C2.4901 56.6544 0.5 66.6148 0.5 77.4391C0.5 84.2996 1.61702 90.7679 3.85425 96.8404L3.8558 96.8445C6.08991 102.749 9.12394 108.02 12.959 112.654L12.959 112.654L12.9646 112.661C16.8027 117.138 21.2829 120.739 26.4034 123.459L26.4033 123.459L26.4144 123.465C31.5505 126.033 37.0873 127.316 43.0178 127.316C47.5035 127.316 51.6783 126.595 55.5376 125.148L55.5376 125.148L55.5477 125.144C59.5516 123.542 63.0052 121.456 65.9019 118.881L65.5697 118.507Z"
                      id="b56e9dab-6ccb-4d32-ad02-6b4bb5d9bbeb"
                  ...
                  <figure className="mt-10 flex flex-auto flex-col justify-between">
                    <blockquote className="text-lg/8 text-gray-900 dark:text-gray-100">
                      <p>
                        Bob has proved himself a highly effective engineer
                        prepared to tackle our most complex problems. He takes
                        the time to do things correctly the first time (avoiding
                        other issues down the road in so doing), and is more
                        than capable in working through "new frontiers" both for
                        himself and the team as a whole.”
                      </p>
                    </blockquote>
                    <figcaption className="mt-10 flex items-center gap-x-6">
                      {/* <img
                      ...
                      <div className="text-base">
                        ...
                        <div className="mt-1 text-gray-500 dark:text-gray-400">
                          Supervisor, IT Production Operations
                        </div>
                      </div>
                    </figcaption>
                  </figure>
          ...
          <div className="relative isolate overflow-y-clip bg-white dark:bg-gray-900">
            ...
            >
              Get started
                  ...
                  <Link
                    href="/portfolio"
                    className="text-sm/6 font-semibold text-gray-900 hover:text-orange-600 dark:text-white dark:hover:text-orange-400"
                  >
