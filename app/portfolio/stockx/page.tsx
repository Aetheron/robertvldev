...
export default function StockX() {
  ...
  const cards: CardType[] = [
    ...
    },
    {
      ...
      front: <CodeBracketSquareIcon className="w-full h-12" />,
      back: (
        <p>
          Pull in shared UI components from private CDN for unified branding and
          UX
        </p>
      ),
    },
    ...
    >
      <div className="m-4 text-lg">
        ...
        <ul className="ml-4 list-disc">
          ...
          <li>Worked with client marketing team to set up Segment analytics</li>
        </ul>
      </div>
    </PortfolioPageTemplate>
  )
